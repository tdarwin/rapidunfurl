...
class UnitTests(unittest.TestCase):
    ...
    def test_custom_embed(self):
        custom = rapidunfurl.unfurl(
            "https://news.ycombinator.com/item?id=16319505")
        self.assertEqual(
    ...
    def test_oembed(self):
        oembed = rapidunfurl.unfurl(
            "https://www.youtube.com/watch?v=v-eK_cpTsOw")
        self.assertEqual(
            "https://www.youtube.com/",
            oembed["provider_url"], "oembed:provider_url")
        self.assertEqual(
            "https://www.youtube.com/watch?v=v-eK_cpTsOw",
            oembed["url"], "oembed:url")
        self.assertEqual(
            "Adam Savage Answers: What's the " +
            "Scariest Experience You've Had on Mythbusters?",
            oembed["title"], "oembed:title")
        self.assertEqual(
            "YouTube", oembed["provider_name"],
    ...
    def test_open_graph(self):
        ...
        self.assertEqual(
            "https://m.media-amazon.com/images/M/MV5BZDJjOTE0N2EtMmRlZS0" +
            "0NzU0LWE0ZWQtM2Q3MWMxNjcwZjBh" +
            "XkEyXkFqcGdeQXVyNDk3NzU2MTQ@._V1_FMjpg_UX1000_.jpg",
            og["image"],
            "og:image")
        self.assertEqual(
            "https://www.imdb.com/title/tt0117500/", og["url"], "og:url")
    ...
    def test_twitter_card(self):
        card = rapidunfurl.unfurl(
            "https://developer.twitter.com/en" +
            "/docs/twitter-for-websites/cards/overview/markup")
        self.assertEqual(
            "https://cdn.cms-twdigitalassets.com/content/dam" +
            "/developer-twitter/redesign-2021-images/og-social-card" +
            "/devwebsite_card_tn.jpg.twimg.768.jpg",
            card["image"], "card:image")
        self.assertEqual(
            "https://developer.twitter.com/en/docs" +
            "/twitter-for-websites/cards/overview/markup",
            card["url"], "card:url")
        self.assertEqual(
